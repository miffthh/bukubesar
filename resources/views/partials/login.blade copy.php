...
<body class="text-center">
    <main class="form-signin w-100 m-auto">
        <div class="card">
            <div class="card-body">
                <form action="/loginproses" method="post">
                    ...
                    <p class="text-center small mt-1">Enter your email & password to login</p>
                    ...
                    <button class="w-100 btn btn-lg btn-primary mb-1 mt-3" type="submit">Sign in</button>
        ...
        <footer id="footer" class="footer small mt-3">
            <div class="copyright">
